...
- `uv`
- `ffmpeg`
- local environment capable of running `transformers` + `torch` + `librosa`
...
Transcription is local-only and uses `CohereLabs/cohere-transcribe-03-2026` through `transformers`.
